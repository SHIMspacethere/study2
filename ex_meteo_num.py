...
def loadImages():
    rockImageList = ['rock01.png', 'rock02.png', 'rock03.png', 'rock04.png', 'rock05.png',
                     'rock06.png', 'rock07.png', 'rock08.png', 'rock09.png', 'rock10.png',
                     'rock11.png', 'rock12.png', 'rock13.png', 'rock14.png', 'rock15.png',
                     'rock16.png', 'rock17.png', 'rock18.png', 'rock19.png', 'rock20.png']

    rockImage = []
    for i in range(len(rockImageList)):
        tempImage = pygame.image.load("images/" + rockImageList[i]).convert_alpha()
        rockImage.append(tempImage)
...
def runGame( ) :
  ...
  missileXY = []  # 무기 좌표 리스트
  rock_list = loadImages()
  rockImage = random.choice(rock_list)
  ...
  rockSize = rockImage.get_rect( ).size  # 운석크기
  ...
  while not onGame :
    ...
    for i, rock in enumerate(rock_list):
        rockX, rockY, rock_speed = rockImage
        rockY += rock_speed
    ...
    """        
    rockAngle += 2  # 추가: 운석의 회전 속도
    if rockAngle >= 360:
        rockAngle = 0

        # 회전한 운석 이미지 그리기
    rotated_rock = pygame.transform.rotate(rock, rockAngle)  # 추가: 운석 이미지 회전 
    ...
    if rockY > padHeight :
      ...
      rockSize = rockImage.get_rect( ).size
      rockWidth = rockSize[ 0 ]
      rockHeight = rockSize[ 1 ]
      rockX = random.randrange( 0, padWidth - rockWidth )
      rockY = 0
